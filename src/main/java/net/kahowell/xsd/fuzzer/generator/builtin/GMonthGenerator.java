...
/**
 * Generates a value for the built-in type gMonth.
 * 
 ...
 */
@Singleton
@GeneratesType(namespace = "http://www.w3.org/2001/XMLSchema", localname = "gMonth")
public class GMonthGenerator extends AbstractXsdTypeValueGenerator {
	...
	protected String generateRandomValue(SchemaType rootType) {
		return new SimpleDateFormat("MM").format(new Date(random.nextLong()));
	}
}
